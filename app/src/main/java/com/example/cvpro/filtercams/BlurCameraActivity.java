 ...
 *   블러 필터 효과 CAM 액티비티
 */
public class BlurCameraActivity extends AppCompatActivity
    ...
    // 네이티브 메소드 먼저 로드
    public native void ConvertRGBtoBlur(long matAddrInput, long matAddrResult, long matAddrtCapture);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        ConvertRGBtoBlur(matInput.getNativeObjAddr(), matResult.getNativeObjAddr(), captureMat.getNativeObjAddr());
        return matResult;
    }
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder( BlurCameraActivity.this);
        builder.setTitle("알림");
